...
// Get poap info
func (c *cPoap) GetPoapsDetail(ctx context.Context, req *v1.PoapDetailReq) (res []*v1.PoapDetailPoapRes, err error) {
	res = service.Poap().GetPoapsDetail(ctx, model.GetPoapsDetailsInput{PoapIds: []string{req.PoapId}})
	return
}
